...
export const Slide = () => {
  ...
  const handleClick = () => {
    toast.error('Your wallet is not connected. Please connect your wallet.', {
      className: 'play-button',
      style: {
        fontSize: '14px',
        color: '#fff',
        backgroundColor: '#7225d6',
      },
    });
  };
            ...
            <div className="fixSlide">
              ...
              <div>
                ...
                <div className="fixBottom">
                  <div className="fixBtn play-button"  onClick={handleClick}>PLAY NOW</div>
                </div>
              </div>
            </div>
          </div>
