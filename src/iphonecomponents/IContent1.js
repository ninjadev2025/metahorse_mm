      ...
      <div className="topTitle">
        <div className="topText">
          ...
          <div className="text">
            ...
            <span className="title title2">MUNTYHUB</span>
          </div>
        ...
        <div className="title3">
          <span>
            ...
            <span style={{ color: "white" }}>MUNTY</span>.Immerse yourself in
            the <span style={{ color: "white" }}>MUNTY</span> ecosystem, and
          ...
          <div className="borderTitle centerTitle">
            ...
            <div className="bottomTitle2 bottomTitle">
              <div className="middleIconC">
                <div className="middleIconText">
                  <span>Get</span>
                  <span style={{ color: "#5F3DFF" }}>MUNTY</span>
                  <span>Tokens</span>
                </div>
              </div>
              <div className="middleText">
                <span>
                  Learn about the{" "}
                  <span style={{ color: "white" }}>$MUNTY</span> governance
